...
function Footer() {
  return (
    <footer className="bg-gradient-to-b from-primary-500 to-primary-400 grid grid-cols-1 items-center justify-items-center w-full">
      {/* left section */}
      ...
      <div className="">
        ...
        <div className="my-5">
          <div className="flex space-x-10">
            <PhoneIcon className="text-green h-8 w-8" />
          </div>
        </div>
      </div>
    </footer>
